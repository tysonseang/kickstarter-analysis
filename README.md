...
The purpose of this project is to support an up-and-coming playwright analyze data from the crowdfunding website Kickstarter to help guide the launch of her first crowdfunding campaign. 
